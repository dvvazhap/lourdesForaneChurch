...
#pope_content a,#cardinal_content a,#bishop_content a{ font-size:20px; color:black; line-height:1.5em;}
...
#pope_name a{color:black;margin-left:10px; margin-bottom:10px;}
...
#cardinal_name a{color:black;margin-left:10px; margin-bottom:10px;}
...
<div id='bishop_wrapper' onclick='show_links(3)' ><h2 style='color:black'><div id='bishop_heading'>OUR BISHOP</div></h2><img src='images/alapatt.png' />
...
<div id='pope_content'>
<b style='color:black;font-size:25px;'><i>See Also :</i></b>
