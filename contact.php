...
?><style type="text/css">
#title{color:#ff3747;text-align:center;font-size:50px;}
#row1{line-height:1.5em;font-size:40px;padding:0%;margin-bottom:120px;text-align:center;height:330px;color:#000111;}
#row2{line-height:1.5em; font-size:40px; padding:0%;text-align:center;margin-bottom:30px;height:300px;color:#000111;}
...
#c23 div{width:400px;margin-top:50px;margin-left:330px; font-weight:bold;
...
#address{color:#000032;font-style:italic;height:80px;font-size:20px;padding-top:20px;margin-top:10px;}
#name{color:#632c01;}
</style>
